...
#     SHEZ: Changed upstream code here to set default value of build_ffmpegsumo
#           to 0.  This dll will likely not be used by us, adds significantly
#           to the build time, and even if we did use it, we can always ship it
#           later.
#

{
  ...
  'variables': {
    ...
    'use_system_ffmpeg%': 0,
    # SHEZ: Changed default of build_ffmpegsumo to 0, see comment at the top of
    #       this file.
    'build_ffmpegsumo%': 0,
